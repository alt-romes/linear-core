...
%
%\item
  Linear types permeate Haskell down to (its) Core, the
        ...
        %We present Core and its formal
...
coercions}) in Section~\ref{sec:discussion}, which concludes the document.
...
\end{lstlisting}
%
In this example, the \lstinline{handle} appears to be closed before
