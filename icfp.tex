...
usage environment $\{x,y\}$, the resources that are used in its body. Thus, in
...
The key idea to guarantee these is to provide a $\textsc{Split}$ rule that
...
rejected by the typechecker are counted dually, also accross every optimisation
...
\begin{itemize}
    ...
    \item Programs which \emph{actually violate linearity}, in that the term
        ...
        fusion~\cite{10.1145/165180.165214,10.1145/1291151.1291199,10.1007/978-3-642-24276-2_2}, and
        others too, could produce linearly-invalid programs (in one such case,
