...
\[
  \begin{array}{c}
    ...
    \Gamma, \ov{y_i :_\omega \sigma_i} , z:_{\Delta'} T ;\Delta , \ov{y_j :_1 \sigma_j} \vdash (\Theta \mid e) \Downarrow (\Theta' :
      K~\ov{x_i}) : T , e'\ov{[x_i/y_{i,j}]}[K~\ov{y_{i,j}}/z] : \tau ,\Sigma \\
    ...
    {K : \ov{ \sigma_i
    \rightarrow_\omega \sigma_j \lolli} T\\
    \Gamma, z:_{\Delta'} T ; \Delta, \Delta' \vdash (\Theta \mid e) \Downarrow (\Theta' \mid
    K~\ov{x_i}) : T , e'[K~\ov{x_i}/z], \Sigma \quad
