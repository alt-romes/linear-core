...
\[
  \begin{array}{c}
    ...
    \\
    \Gamma, z{:}_{\Delta'}T, \ov{y_i :_\omega \sigma_i} ;\Delta , \ov{y_j :_1 \sigma_j} \vdash (\Theta \mid e) \Downarrow (\Theta' \mid
...
\begin{tabbing}
    ...
    (6) $\G', z{:}_{\irr{\D_a}}\s; \irr{\D_a}, \D_b \vdash_{alt} K~\ov{y_i} \to e' :^z_{\irr{\D_a}} \s $\` by inv on case\\
\end{tabbing}
\end{description}
\end{proof}
