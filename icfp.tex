...
\[
  \begin{array}{c}
    ...
    \Gamma, \ov{y_i :_\omega \sigma_i} ;\Delta , \ov{y_j :_1 \sigma_j} \vdash (\Theta \mid e) \Downarrow (\Theta' \mid
      K~\ov{x_i}) : T , e'\ov{[y_{i,j}/x_i]}[K~\ov{y_{i,j}}/z] : \tau ,\Sigma \\
    \Gamma ;\Delta \vdash (\Theta' \mid e') \Downarrow (\Theta'' \mid v) :\tau , \Sigma }
    ...
    {K : \ov{ \sigma_i
    \rightarrow_\omega \sigma_j \lolli} T\\
    \Gamma, ; \Delta, \Delta' \vdash (\Theta \mid e) \Downarrow (\Theta' \mid
    K~\ov{x_i}) : T , e'[K~\ov{x_i}/z]TODO, \Sigma \quad
