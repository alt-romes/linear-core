...
\[
  \begin{array}{c}
    ...
    (\Theta' \mid e'[\pi/p]) \Downarrow (\Theta'' \mid v) : \sigma}
 ...
 \begin{definition}[Well-typed State]
   We write $\vdash \Theta \mid e : \tau$ to denote:

   \[
\vdash \llet{\Theta}{e} : \tau
   \]
...
\begin{theorem}[Type Preservation]
  Let $(\Theta \mid e) \Downarrow (\Theta' \mid v) : \tau$.
  If $\vdash \Theta \mid e : \tau$ then $\vdash \Theta' \mid v : \tau$
