...
mutated in order to express evaluation\todo{aqui não seria sharing?}. Terms are explicit about
...
$e :_\pi \tau$ or $x :_\Delta \tau$\todo{isto não me fez sentido} which are expressions in which
...
considered semantically linear in a call-by-need calculus but violates
linearity in a call-by-name one:
%
