...
% diverse problems with linearity spring up when we get past the desugarer and the
...
We propose to formalise a type system that is able to type check linear
\emph{Core} at all points in the core pipeline and then to implement it into
GHC. Proposal... \todo{proposal paragraph}
