...
\noindent \ROUNDTWO{While GHC's Core language is our main focus, we
note that the ideas explored in this work can potentially be applied to any
language with non-strict features, even if the language itself is strict.}

Additional proofs and definitions are given in \ROUNDTWO{TODO}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Linearity, Lazily\label{sec:linearity-semantically}}
...
section \ROUNDTWO{aims to} make clear, in linear type systems for non-strict languages, a
distinction between using resources \emph{syntactically} and \emph{semantically} is needed.
%
...
\subsection{Lazy Linearity by Example\label{sec:semantic-linearity-examples}}
