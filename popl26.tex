...
all intermediate programs produced by GHC. The total of programs
rejected is counted in the same way, without ever halting compilation when a
program is rejected. We note that our implementation is not performance
