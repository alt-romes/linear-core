...
%
\ROUNDTWO{While this distinction is largely unexplored, it becomes unavoidable
    for} Haskell's optimising compiler, which heavily rewrites the source
...
is suitable for the Core intermediate language of the
Glasgow Haskell Compiler. We prove \ROUNDTWO{that} Linear Core is sound,
guarantees linear resource usage, and \ROUNDTWO{that} multiple
...
%
%
Additionally, we \ROUNDTWO{that} show our system
%
