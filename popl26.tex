...
\setcctype{by}
\acmJournal{PACMPL}
\acmYear{2026} \acmVolume{10} \acmNumber{POPL} \acmArticle{69} \acmMonth{1} \acmPrice{}
...
%\begin{itemize}
% \item
Programs we expected GHC to produce, but know are not seen as linear by $\lambda^\pi_\Delta$.
...
programs rejected due to the lack of ``linearity coercions'' in
...
programs which actually violate linearity, in that the term
