...
\title{A Glimpse at Linearity in the Haskell Compiler}
...
% I don't have a lot of time so let's get straight into making sense out of this

\begin{frame}{Haskell is a functional language}
...
\begin{frame}{With Lazy Evaluation}
\begin{code}
madd1 :: Bool -> Int -> Int
madd1 condition x =
  let y = add1 x
...
\pause
\begin{itemize}
\item We don't compute |add1| \emph{at all} if the condition is false
\end{itemize}
\end{frame}
