...
\renewcommand{\TypeCaseWHNF}{
    ...
    \\ \ov{\judg[\G,\zD][\D,\D']{\rho\to e'}{\s \Longrightarrow \vp}[alt][\D]}}
...
\newcommand{\TypeCaseNotWHNFIncorrect}{
    ...
    \judg{e}{\s}
    \\ \ov{\judg[\subst{\G}{\irr{\D}}{\D},z{:}_{\irr{\D}}\s][\irr{\D},\D']{\rho\to e'}{\s \Longrightarrow \vp}[alt][\irr{\D}]}}
...
\renewcommand{\TypeCaseNotWHNF}{
    ...
    {\textrm{e is definitely not in \emph{WHNF}} \\
    \judg{e}{\s}
    \\ \ov{\judg[\G,z{:}_{\irr{\D}}\s][\irr{\D},\D']{\rho\to e'}{\s \Longrightarrow \vp}[alt][\irr{\D}]}}
    {\splitjudg{\ccase{e}{\z[\irr{\D}]~\{\ov{\rho \to e'}\}}}{\vp}}
    % TODO: Add that [d1] entails moving all delta usages to [delta] usages in all vars i d1
}
...
\renewcommand{\TypeCaseVar}{
    ...
    \\ \ov{\judg[\G][\D',\xl][\d',z{:}_x\s]{\rho\to e'}{\s \Longrightarrow \vp}[alt][x]}}
...
\renewcommand{\TypeAltZero}{
    \mprset{flushleft}
    \infer[(Alt0)]
    { \judg[\subst{\G}{\cdot}{\D_s},\ov{\xo}][\subst{\D}{\cdot}{\D_s}]{e}{\vp}
    }
    {\judg{K~\ov{\xo}\to e}{\s \Longrightarrow \vp}[alt][\D_s]}
}

\renewcommand{\TypeAltWild}{
    \mprset{flushleft}
    \infer[(Alt\_)]
    { \judg{e}{\vp} }
...
%     \TypeCaseVar
\\[2em]
    \judgment{\judg{\rho \to e}{\sigma \Rightarrow \varphi}[alt][\Delta_s]}
\\[1em]
    \TypeAltN
\\[1em]
    \TypeAltZero
