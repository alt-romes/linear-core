...
$\G ; \D_1,\D_2,\D_3  \vdash \llet{x = e_1}{\ccase{e}{\{\overline{\rho_j\to
   ...
   ~  
     \begin{tabbing}
       ...
       $\judg[\G, z{:}_{\ov{\Delta_i}} \sigma,\ov{\xo},\ov{y_i{:}_{\D_i}\s_i}^n][\D_2]{e_1}{\sigma'}$
       \` by inversion\\
       $\judg[\G, x{:}_{\D_2}\sigma', z{:}_{\ov{\Delta_i}} \sigma,\ov{\xo},\ov{y_i{:}_{\D_i},\s_i}^n][\D_2]{x}{\sigma'}$
       \` by Var$_\Delta$, with $x$ fresh\\
      $\judg[\G][\D_2]{e_1}{\sigma'}$
       \` by assumption\\
       $\judg[\G,
       x{:}_{\D_2}\sigma', z{:}_{\ov{\Delta_i}} \sigma,\ov{\xo},\ov{y_i{:}_{\D_i}\s_i}^n][\ov{\D_i},\D_2,\D_3]{E[x]}{\vp}$
       \` by context instantiation\\
       $\G,x{:}_{\D_2}\sigma',\var[z][\ov{\D_i}];\ov{\D_i},\D_2,\D_3 \vdash_{alt} \rho_j
