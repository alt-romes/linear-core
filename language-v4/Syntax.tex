...
% TODO: Introduzir tagged resources
  \Gamma   & ::=  & \cdot \mid \Gamma,x{:}_\omega\sigma \mid \Gamma,K{:}\sigma \mid \Gamma,p \mid \Gamma,z{:}_{\Delta}\sigma & \textrm{Unrestricted (delta-)variables} \\
...
\begin{array}{lcl}
  \pi, \mu & ::= & 1 \mid \omega \mid p \qquad decl  ::=  \datatype{T~\overline{p}}{\overline{K:\overline{\sigma \to_\pi}~T~\overline{p}}} %\mid \pi + \mu \mid \pi \cdot \mu\\
