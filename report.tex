...
have linear types --
% , with Rust\cite{} (with its ownership types), Idris\{}, and recently
% Haskell\cite{} being the most popular.
...
users of libraries.
% , and, e.g., avoid the required boilerplate threading of linear resources that we will get to know ahead.
