...
disjunction operator ($\oplus$) and the $\bang$ modality operator. A typing
...
constructor}} type constructor \texttt{IO}. Some of the example programs will look though as
...
(e.g. a \textt{NonEmpty} is a list that can not be empty).
