...
linear Haskell program since the typechecker cannot tell that $x$ is used
linearly, but this program might occur naturally in Core from
...
Is this program really still linear? If one looks at it 
