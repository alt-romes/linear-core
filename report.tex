...
\texttt{NonEmpty} is a list that can not be empty). A well liked motto is "make
...
can write a completely safe \texttt{head} function. This is done by expressing that the size
