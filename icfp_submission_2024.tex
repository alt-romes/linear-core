...
\[
  \begin{array}{c}
    ...
    \qquad
    \infer[]
    {\Gamma : e \Downarrow \Delta : \lambda x:_\pi \sigma . e' \quad
    ...
    \qquad
    \infer[]
    {(\Gamma,x:_\omega \sigma = e) : e' \Downarrow \Delta : v}
    {\Gamma : \llet{x{:}_{\Delta}\sigma = e}{e'}\Downarrow \Delta : v
    }\\[1.5em]
    \infer[]
    {\,}
    ...
    \Delta : e'[x_i/y_i] \Downarrow \Theta : v }
    {\Gamma : \ccase{e}{z{:}_{\Delta}\sigma~\{\overline{\dots,K~y_1~\dots~y_n\to e'}\}}
...
similar to that of \cite{cite:linearhaskell}.
