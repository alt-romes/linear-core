...
\input{proofs/TypePreservationTheorem}

\input{proofs/ProgressTheorem}

\input{proofs/LinearSubstitutionLemma}

\input{proofs/UnrestrictedSubstitutionLemma}

\input{proofs/DeltaSubstitutionLemma}
